...
export const signUpFail = (error) => createAction(USER_ACTION_TYPES.SIGN_IN_FAILURE, error)
...
export const signOutFail = (error) => createAction(USER_ACTION_TYPES.SIGN_OUT_FAILURE, error);
